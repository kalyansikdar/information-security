...
public class DecryptionLogics {
	
	public static String DESBasicDecryption(String cipherText, String key) throws Exception {
		...
		try {
			...
			String leftBits = "";
			String rightBits = "";
			String currentBlock = cipherText;
			...
			System.out.println(
					"\n************** FIRST ROUND OF DECRYPTION COMPLETE****************");
			...
			for (int position = 0; position < L2.length; position++)
				System.out.print(L2[position]);
			System.out.println(
					"\n************** SECOND ROUND OF DECRYPTION COMPLETE****************");
			
			System.out.println("\n\n - - - - DECRYPTION OF THE BLOCK IS COMPLETED - - - -");
			...
			System.out.println("DECRYPTED TEXT BLOCK: " + encryptedTextBlock);
